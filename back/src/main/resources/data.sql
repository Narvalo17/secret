...
MERGE INTO stores (name, slug, description, image_url, owner_id, category_id, address, phone, email, website, first_name, last_name, password, confirm_password, is_active, created_at, updated_at)
KEY(slug)
